...
function renderEverything(){
    ...
    getDeleteBtn().style.display = 'box'
}
...
function renderPokemon(pokeData){
    ...
    let pokeWeight = document.createElement('w1') 
...
function createPokeImage(pokeID, containerDiv){
    ...
    pokeImage.srcset = `https://pokeres.bastionbot.org/images/pokemon/${pokeID}.png`;innerWidth = 50%
